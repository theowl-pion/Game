...
const userSchema = new mongoose.Schema(
  {
    ...
    password: {
      ...
      validate: {
        ...
        message: () =>
          `Password must be at least 8 characters long and include uppercase, lowercase letters and a digit.`,
      },
    },
    ...
    gameAccess: {
      type: Boolean,
      default: true,
      description: "Controls whether the user can play the game",
    },
  },
  { timestamps: true }
);
